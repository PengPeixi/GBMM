...
def main(args):
    ...
    if not os.path.exists("./p4_results"):
        os.makedirs("./p4_results")

    # Load the training/validation and test datasets
    # test_csv_path = '/root/autodl-tmp/test/3d/data/standardized_features_new.csv'
    test_csv_path = '/root/autodl-tmp/p45_data/p45_man_c1/standardized_features.csv'
    ...
    test_images_path = np.array(["/root/autodl-tmp/p45_data/p45_man_c1/image/" + path for path in test_images_path])
    ...
    for fold in range(0,2):
        ...
        csv_file_path = f"./p4_results/fold_{fold + 1}_epoch_{epoch}_test_predictions.csv"
