...
# 读取两个CSV文件
val_train_df = pd.read_csv('/root/autodl-tmp/test2/2d/v1/fold8_pretrain/results_post_p45/man/c1/aggregated_predictions_val.csv')
train_best_df = pd.read_csv('./p4_results/five_epoch_predictions.csv')
