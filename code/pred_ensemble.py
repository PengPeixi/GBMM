...
# 读取两个CSV文件
val_train_df = pd.read_csv('/root/autodl-tmp/v1/2d/code/2d_new_code/results_post/aggregated_predictions_val.csv')
# val_train_df = pd.read_csv('/root/autodl-tmp/v1/2d/code/2d_new_code/results_post/aggregated_predictions.csv')
# train_best_df = pd.read_csv('/root/autodl-tmp/v1/3d/code/3d_code/results_post/fold_1_epoch_39_test_predictions.csv')
train_best_df = pd.read_csv('./results_post/five_epoch_predictions.csv')
